...
typedef std::vector<cTransponder *>::const_iterator vTpIter;
...
public:
   ...
   bool LoadTpl(std::string tpList);
   void CalcTerrTpl(); 
...
private:
   ...
   std::string SetPosition(std::string tplFileName);
